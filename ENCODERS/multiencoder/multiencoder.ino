...
#define ENCODER_N 4
const int IntPin = 12;
i2cEncoderMiniLib encoder[ENCODER_N] = { i2cEncoderLib(0x30), i2cEncoderLib(0x31), i2cEncoderLib(0x32), i2cEncoderLib(0x33)}; //Class initialization with the I2C addresses 
